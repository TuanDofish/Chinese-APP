...
class _GrammarCheckerScreenState extends State<GrammarCheckerScreen>
    ...
    "HSK 3": [
      ...
      },
      {
        ...
        "examples": [
          {
            "cn": "书被他拿走了。",
            "py": "Shū bèi tā ná zǒu le.",
            "vi": "Sách bị anh ấy lấy đi rồi.",
          },
        ],
      },
      {
        ...
        "examples": [
          {
            "cn": "天气越来越冷。",
            "py": "Tiānqì yuè lái yuè lěng.",
            "vi": "Thời tiết càng ngày càng lạnh.",
          },
        ],
      },
    ],
  ...
  void _analyzeText() async {
    ...
    try {
      final result = await GrammarAiService.checkGrammar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [_buildLessonsTab(), _buildCheckerTab()],
      ),
    );
  }
                ...
                children: [
                  ...
                  ClipRRect(
                    ...
                    child: LinearProgressIndicator(
                      value: (_result!['score'] as num).toDouble() / 100,
                      minHeight: 8,
