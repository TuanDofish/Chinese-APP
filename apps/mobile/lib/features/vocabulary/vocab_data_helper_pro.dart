class VocabDataHelper {
  ...
  static final Map<String, Map<String, dynamic>> _hsk2Map = {
    ...
    "红": {
      "meaning": "Màu đỏ",
      "examples": [
        {"cn": "红色的苹果。", "py": "Hóngsè de píngguǒ.", "vi": "Quả táo màu đỏ."},
      ],
    },
    "白": {
      "meaning": "Màu trắng",
      "examples": [
        {"cn": "白色的衣服。", "py": "Báisè de yīfu.", "vi": "Quần áo màu trắng."},
      ],
    },
    "黑": {
      "meaning": "Màu đen",
      "examples": [
        {"cn": "黑色的车。", "py": "Hēisè de chē.", "vi": "Chiếc xe màu đen."},
      ],
    },
    ...
    "早上": {
      "meaning": "Buổi sáng",
      "examples": [
        {"cn": "早上好。", "py": "Zǎoshang hǎo.", "vi": "Chào buổi sáng."},
      ],
    },
    "晚上": {
      "meaning": "Buổi tối",
    ...
    "每天": {
      ...
      "examples": [
        {
          "cn": "我每天都学汉语。",
          "py": "Wǒ měitiān dōu xué Hànyǔ.",
          "vi": "Tôi học tiếng Trung mỗi ngày.",
        },
      ],
    },
    "虽然": {
      "meaning": "Tuy, mặc dù",
      "examples": [
        {"cn": "虽然...", "py": "Suīrán...", "vi": "Tuy rằng..."},
      ],
    },
    "但是": {
      "meaning": "Nhưng",
      "examples": [
        {"cn": "但是...", "py": "Dànshì...", "vi": "Nhưng mà..."},
      ],
    },
    ...
    "介绍": {
      ...
      "examples": [
        {
          "cn": "我来介绍一下。",
          "py": "Wǒ lái jièshào yíxià.",
          "vi": "Để tôi giới thiệu một chút.",
        },
      ],
    },
    "准备": {
      ...
      "examples": [
        {
          "cn": "你准备好了吗？",
          "py": "Nǐ zhǔnbèi hǎo le ma?",
          "vi": "Bạn chuẩn bị xong chưa?",
        },
      ],
    },
    "可以": {
