...
class _PronunciationScreenState extends State<PronunciationScreen>
  ...
  static const List<PronunciationLesson> _lessons = [
    // HSK 1
    PronunciationLesson(chinese: "你好", pinyin: "Nǐ hǎo", vietnamese: "Xin chào", level: "HSK 1"),
    PronunciationLesson(chinese: "谢谢", pinyin: "Xièxiè", vietnamese: "Cảm ơn", level: "HSK 1"),
    PronunciationLesson(chinese: "对不起", pinyin: "Duìbuqǐ", vietnamese: "Xin lỗi", level: "HSK 1"),
    PronunciationLesson(chinese: "我是学生", pinyin: "Wǒ shì xuésheng", vietnamese: "Tôi là học sinh", level: "HSK 1"),
    PronunciationLesson(chinese: "今天天气很好", pinyin: "Jīntiān tiānqì hěn hǎo", vietnamese: "Hôm nay thời tiết rất đẹp", level: "HSK 1"),
    // HSK 2
    PronunciationLesson(chinese: "我喜欢学习中文", pinyin: "Wǒ xǐhuān xuéxí Zhōngwén", vietnamese: "Tôi thích học tiếng Trung", level: "HSK 2"),
    PronunciationLesson(chinese: "你吃饭了吗", pinyin: "Nǐ chīfàn le ma", vietnamese: "Bạn đã ăn cơm chưa?", level: "HSK 2"),
    PronunciationLesson(chinese: "我每天都去上班", pinyin: "Wǒ měitiān dōu qù shàngbān", vietnamese: "Mỗi ngày tôi đều đi làm", level: "HSK 2"),
    // HSK 3
    PronunciationLesson(chinese: "我在北京学习汉语", pinyin: "Wǒ zài Běijīng xuéxí Hànyǔ", vietnamese: "Tôi đang học tiếng Trung tại Bắc Kinh", level: "HSK 3"),
    PronunciationLesson(chinese: "学习语言需要很多时间", pinyin: "Xuéxí yǔyán xūyào hěnduō shíjiān", vietnamese: "Học ngôn ngữ cần rất nhiều thời gian", level: "HSK 3"),
    // HSK 4
    PronunciationLesson(chinese: "通过努力学习，我的中文越来越好", pinyin: "Tōngguò nǔlì xuéxí, wǒ de Zhōngwén yuè lái yuè hǎo", vietnamese: "Thông qua học tập chăm chỉ, tiếng Trung của tôi ngày càng tốt hơn", level: "HSK 4"),
    PronunciationLesson(chinese: "中国文化非常丰富多彩", pinyin: "Zhōngguó wénhuà fēicháng fēngfù duōcǎi", vietnamese: "Văn hóa Trung Quốc vô cùng phong phú đa dạng", level: "HSK 4"),
  ];
  ...
  Future<void> _startListening() async {
    if (!_speechAvailable) {
      _showSnack("Máy không hỗ trợ nhận dạng giọng nói. Vui lòng thử trên điện thoại thật.");
      return;
    }
    setState(() {
      _recognizedText = '';
  ...
  double _calculateSimilarity(String target, String recognized) {
    ...
    double unorderedScore = t.isNotEmpty ? (unorderedMatches / t.length) * 100 : 0;
  ...
  Map<String, dynamic> _buildScoreResult(String target, String recognized, double score) {
    String grade;
    Color gradeColor;
    String feedback;
    List<String> tips = [];
    ...
    if (score >= 92) {
      ...
      tips.add("Chú ý thanh điệu tiếng Trung: 1-bằng, 2-lên, 3-xuống-lên, 4-xuống, nhẹ.");
      tips.add("Luyện phát âm Pinyin trước khi đọc chữ Hán.");
    } else {
      grade = "Hãy thử lại! 🎯";
      gradeColor = Colors.red;
      feedback = "Máy không nhận ra câu bạn đọc. Thử đọc to hơn và rõ ràng hơn.";
  ...
  void _prevLesson() {
    final list = _filteredLessons;
    setState(() {
      _currentLessonIndex = (_currentLessonIndex - 1 + list.length) % list.length;
      _recognizedText = '';
      _scoreResult = null;
    });
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Column(
                children: [
                  const Text("Bấm và đọc câu bên trên:",
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      _recognizedText.isEmpty ? "(Không nhận ra)" : _recognizedText,
                      style: const TextStyle(
              ...
              const Center(
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text("AI đang chấm điểm phát âm...",
