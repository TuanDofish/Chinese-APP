...
class _VocabularyListScreenState extends State<VocabularyListScreen>
  ...
  static const Map<String, Map<String, dynamic>> _levelMeta = {
    ...
    'HSK 2': {
      ...
      'desc': 'Mở rộng 150 từ vựng giao tiếp hàng ngày, tự tin trò chuyện đơn giản!',
      'total': 150,
    },
    'HSK 3': {
    ...
    'HSK 4': {
      ...
      'desc': 'Làm chủ 600 từ vựng chuyên sâu, đọc hiểu và viết bài tiếng Trung!',
      'total': 600,
    },
  };
    ...
    "HSK 2": [
      {
        ...
        "words": ["丈夫","妻子","哥哥","姐姐","弟弟","妹妹","孩子","男人","女人","爷爷","奶奶","儿子"],
      },
      {
        "id": "hsk2_body",
        "name": "Cơ thể & Sức khỏe",
        "imageFile": "hsk2_body.png",
        "words": ["眼睛","耳朵","鼻子","嘴","头","手","脚","身体","病","药","医生","医院"],
      },
      {
        "id": "hsk2_emotion",
        "name": "Cảm xúc",
      ...
      },
      {
        ...
        "words": ["考试","问题","回答","帮助","教","懂","问","班","课","黑板","铅笔","历史","数学"],
      },
      {
        "id": "hsk2_food",
        "name": "Ăn uống & Mua sắm",
        "imageFile": "hsk2_food.png",
        "words": ["鸡蛋","鱼","牛奶","面条","蛋糕","西瓜","便宜","贵","卖","超市","服务员","价格"],
      },
      {
        "id": "hsk2_weather",
        "name": "Thời tiết",
        "imageFile": "hsk2_weather.png",
        "words": ["天气","晴","阴","下雨","雪","风","春","夏","秋","冬","冷","热","云","花","树"],
      },
      {
        "id": "hsk2_transport",
        "name": "Giao thông & Du lịch",
        "imageFile": "hsk2_transport.png",
        "words": ["公共汽车","地铁","自行车","飞机","飞机场","护照","旅游","离开","到","近","远"],
      },
      {
        "id": "hsk2_verb",
        "name": "Động từ thông dụng",
        "imageFile": "hsk2_verb.png",
        "words": ["跑","走","知道","给","告诉","找","让","开始","完成","准备","等","打","跳","唱","跳舞"],
      },
      {
        "id": "hsk2_color",
        "name": "Màu sắc & Hình dáng",
        "imageFile": "hsk2_color.png",
        "words": ["颜色","红","白","黑","绿","黄","蓝","新","旧","长","短","高","矮","胖","瘦"],
      },
      {
        "id": "hsk2_direction",
        "name": "Phương hướng & Vị trí",
        "imageFile": "hsk2_direction.png",
        "words": ["左","右","上","下","里","外","旁边","中间","前","后","东","西","南","北"],
      },
    ],
    ...
    "HSK 3": [
      {
        ...
        "words": ["办公室","经理","会议","工资","公司","银行","护士","警察","记者","律师","翻译","工程师","服务员","厨师"],
      },
      {
        "id": "hsk3_home",
        "name": "Nhà cửa & Đồ đạc",
        "imageFile": "hsk3_home.png",
        "words": ["客厅","卧室","厨房","卫生间","阳台","冰箱","空调","洗衣机","沙发","镜子","钥匙","电梯","灯","床"],
      },
      {
        "id": "hsk3_emotion",
        "name": "Cảm xúc & Tâm lý",
        "imageFile": "hsk3_emotion.png",
        "words": ["担心","害怕","难过","着急","放心","感觉","态度","幸福","遗憾","安静","紧张","满意","骄傲","难为情"],
      },
      {
        "id": "hsk3_tech",
        "name": "Khoa học & Công nghệ",
        "imageFile": "hsk3_tech.png",
        "words": ["电子邮件","网站","密码","信息","打印","技术","科学","研究","发明","机器","网络","手机","电脑","智能"],
      },
      {
        "id": "hsk3_culture",
        "name": "Văn hóa & Giải trí",
        "imageFile": "hsk3_culture.png",
        "words": ["音乐","电影","节目","新闻","故事","比赛","运动","游戏","爱好","唱歌","跳舞","画","画画","摄影"],
      },
      {
        "id": "hsk3_food",
        "name": "Ẩm thực nâng cao",
        "imageFile": "hsk3_food.png",
        "words": ["饺子","烤鸭","豆腐","包子","火锅","米饭","面条","汤","饮料","咖啡","啤酒","糖","盐","辣"],
      },
      {
        "id": "hsk3_travel",
        "name": "Du lịch & Khám phá",
        "imageFile": "hsk3_travel.png",
        "words": ["旅游","地图","景色","参观","介绍","游览","博物馆","公园","海","山","河","国家","外国","风景"],
      },
      {
        "id": "hsk3_sports",
        "name": "Thể thao",
        "imageFile": "hsk3_sports.png",
        "words": ["运动","篮球","足球","游泳","跑步","锻炼","参加","赢","输","比赛","队","运动员","教练"],
      },
      {
        "id": "hsk3_shopping",
        "name": "Mua sắm",
        "imageFile": "hsk3_shopping.png",
        "words": ["商场","超市","品牌","打折","便宜","贵","价格","收据","退货","换","付钱","信用卡","现金"],
      },
      {
        "id": "hsk3_grammar",
        "name": "Hư từ & Trạng từ",
        "imageFile": "hsk3_grammar.png",
        "words": ["因为","所以","虽然","但是","如果","虽然","而且","一定","可能","应该","必须","已经","还","再","又","一起"],
      },
    ],
    ...
    "HSK 4": [
      {
        ...
        "words": ["经济","市场","竞争","顾客","商品","广告","品牌","投资","利润","合同","价值","资金","营业","贸易"],
      },
      {
        "id": "hsk4_law",
        "name": "Pháp luật & Xã hội",
        "imageFile": "hsk4_law.png",
        "words": ["法律","权利","义务","政府","政策","规定","违反","罚款","保护","制度","民主","公民","案件","律师"],
      },
      {
        "id": "hsk4_health",
        "name": "Y tế & Sức khỏe",
        "imageFile": "hsk4_health.png",
        "words": ["健康","疾病","治疗","手术","检查","药物","症状","预防","保险","急救","医疗","血压","感冒","发烧"],
      },
      {
        "id": "hsk4_education",
        "name": "Giáo dục",
        "imageFile": "hsk4_education.png",
        "words": ["毕业","专业","学位","论文","奖学金","教育","知识","能力","经验","培训","申请","大学","研究生","博士"],
      },
      {
        "id": "hsk4_technology",
        "name": "Công nghệ hiện đại",
        "imageFile": "hsk4_technology.png",
        "words": ["人工智能","互联网","大数据","软件","应用","平台","系统","数据","算法","创新","开发","程序员","科技"],
      },
      {
        "id": "hsk4_environment",
        "name": "Môi trường",
        "imageFile": "hsk4_environment.png",
        "words": ["环境","污染","保护","资源","能源","气候","生态","回收","节约","自然","垃圾","废水","噪音","绿色"],
      },
      {
        "id": "hsk4_media",
        "name": "Truyền thông & Mạng xã hội",
        "imageFile": "hsk4_media.png",
        "words": ["媒体","报道","采访","发布","信息","评论","分享","直播","网络","平台","用户","内容","视频","头条"],
      },
      {
        "id": "hsk4_society",
        "name": "Xã hội & Cuộc sống",
        "imageFile": "hsk4_society.png",
        "words": ["社会","生活","习惯","文化","传统","风俗","人口","城市","农村","发展","进步","变化","影响","意义"],
      },
      {
        "id": "hsk4_psychology",
        "name": "Tâm lý & Tư duy",
        "imageFile": "hsk4_psychology.png",
        "words": ["思想","态度","观点","分析","判断","推理","逻辑","目标","计划","决定","选择","考虑","理解","接受"],
      },
      {
        "id": "hsk4_art",
        "name": "Nghệ thuật & Văn hóa",
        "imageFile": "hsk4_art.png",
        "words": ["文化","艺术","音乐","绘画","电影","文学","诗歌","舞蹈","摄影","建筑","风格","创作","欣赏","表达"],
      },
    ],
  };
  ...
  Future<void> _loadData() async {
    try {
      final String response = await rootBundle.loadString('assets/data/hsk_complete.json');
  ...
  Map<String, dynamic>? _findWordData(String simplified) {
    try {
      return _allWords.firstWhere((w) => w['simplified'] == simplified) as Map<String, dynamic>;
    } catch (_) {
  ...
  Widget build(BuildContext context) {
    ...
    final allLevelWords = topics.expand((t) => (t['words'] as List).cast<String>()).toSet();
      ...
      children: [
        ...
        ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            final learnedCount = wordList.where((w) => _learnedWords.contains(w)).length;
            final progress = wordList.isNotEmpty ? learnedCount / wordList.length : 0.0;
        ...
        children: [
          Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () => setState(() => _sortByProgressDesc = !_sortByProgressDesc),
                child: Container(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: completed ? Border.all(color: const Color(0xFF4CAF50), width: 2) : null,
        ),
        child: Row(
          children: [
            ...
            Stack(
              ...
              children: [
                Container(
                  ...
                  height: 68,
                  decoration: BoxDecoration(
                    color: completed ? const Color(0xFFE8F5E9) : const Color(0xFFF5F7FA),
  ...
  Future<void> _navigateToDetail(List<String> wordList, String topicName) async {
...
class _TopicVisualFallback extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final start = completed ? const Color(0xFFE8F5E9) : levelColor.withOpacity(0.2);
    final end = completed ? const Color(0xFFDFF0E1) : levelColor.withOpacity(0.35);
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  if (!isOnQuiz)
                    IconButton(
                      onPressed: () => setState(() => _showPinyinGlobal = !_showPinyinGlobal),
                      icon: Icon(
                        _showPinyinGlobal ? Icons.translate_rounded : Icons.translate_outlined,
                        size: 20,
